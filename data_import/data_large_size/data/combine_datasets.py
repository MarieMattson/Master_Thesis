...
with open('/mnt/c/Users/User/thesis/data_import/data_large_size/data/result_faiss_qa_dataset_part5.json', 'r', encoding='utf-8') as f:
    data1 = json.load(f)

with open('/mnt/c/Users/User/thesis/data_import/data_large_size/data/result_graph_dataset_part5.json', 'r', encoding='utf-8') as f:
    data2 = json.load(f)
...
# Save to new file
with open('/mnt/c/Users/User/thesis/data_import/data_large_size/data/full_result_merged_2.json', 'w', encoding='utf-8') as f:
